...
namespace AspNetFinalProject.Areas.Manage.Controllers
{
    public class SpecialitiesController : Controller
    {
        ...
        {
            var specialities = db.Specialities.Include(s => s.DepartmentCategory);
            return View(specialities.ToList());
        }

        // GET: Manage/Specialities/Details/5
        ...
        {
            ViewBag.DepartmentCategoryId = new SelectList(db.DepartmentCategories, "Id", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Name,DepartmentCategoryId")] Speciality speciality)
        {
            ...
            ViewBag.DepartmentCategoryId = new SelectList(db.DepartmentCategories, "Id", "Name", speciality.DepartmentCategoryId);
            return View(speciality);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,DepartmentCategoryId")] Speciality speciality)
        {
            if (ModelState.IsValid)
            {
