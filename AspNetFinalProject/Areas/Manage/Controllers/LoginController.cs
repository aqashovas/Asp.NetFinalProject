...
namespace AspNetFinalProject.Areas.Manage.Controllers
{
    public class LoginController : Controller
    {
        ...
        // GET: Manage/Login/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Manage/Login/Create
